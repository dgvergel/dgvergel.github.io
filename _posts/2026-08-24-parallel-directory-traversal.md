...
directory tree simultaneously while collecting partial statistics that will finally be
...
features are still unavailable, most notably private module fragments (`module :private;`).
</div>
